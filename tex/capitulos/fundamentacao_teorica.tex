...
\item[Funções] (1) PF é baseada na aplicação de funções. (2) Faz amplo uso de
  ...
  % https://www.youtube.com/watch?v=yYze0gCBtvY&t=45s
...
\item[Composição de funções] Combinação de funções;
  % https://www.youtube.com/watch?v=qJgff2spvzM&t=666s
...
\subsubsubsection{Aplicações Desktop}
\label{sec:guis-desktop}

% - utilizam toolkits

\subsubsubsection{Aplicações Web}
\label{sec:guis-web}
