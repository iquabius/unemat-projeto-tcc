...
% Pacotes glossaries
% ---
\usepackage[toc,xindy={language=portuguese},translate=babel]{glossaries}
...
% ---
% Domando programação/computação assíncrona/concorrente em interfaces web
% Orquestração de eventos com FRP em interfaces web
\titulo{Interfaces Web com Programação Funcional Reativa}
